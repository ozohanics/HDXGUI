...
struct Spectrum {
  ...
  Spectrum& operator+=(const Spectrum& other) {
      std::copy(other.masses.begin(), other.masses.end(), std::back_insert_iterator<std::vector<double>>(this->masses));
    std::copy(other.intensities.begin(), other.intensities.end(),
        back_inserter(this->intensities));
