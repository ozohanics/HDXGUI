...
#define XML_VERSION 0x12B
#define XML_VERSION_REVISION_DATE "07-08-2007"
...
{
	int deep; // 0 = root
	char* map; // map of name, see PartialLoad
};
...
public:
	...
	static ZXML<char>* ReadToZ(const char*, class XMLTransform* eclass = 0, class XMLTransformData* edata = 0);
	...
	static int PartialLoad(const char* file, XMLPARTIALLOADOPTIONS* d);
...
#endif
double   XMLGetFloat(const char* item, const char* attr, const double defv, const char* xml, XML* af = 0);
...
#endif
int    XMLSetFloat(char* section, char* attr, double v, char* xml, XML* af = 0);
